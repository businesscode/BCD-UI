...
* checkbox and singleSelect widget have a isSwitch parameter for a horizontal slider switch / horizontal switch panel
* label widget added
* chips widget added
...
* input widget supports type time and steps attribute
