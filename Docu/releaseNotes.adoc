...
* Switched to gradle 4.2, added gradle wrapper
...
* Updated 3rd party jars (apache commons etc) to latest versions
* when using cube or scorecard with TemplateManager, RankingEditor or Summary, you need to include bcduiComponent, too
