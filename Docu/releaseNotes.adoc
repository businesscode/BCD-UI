...
* i18nServlet allows not normalized key which are printed out as elements. servlet param "NormalizeKeys false" creates a <i key=''>value</i> xml output with not normalized key attributes
