...
* updated to log4javascript 1.4.16
...
* add the following to your shiro main settings in web.xml: invalidRequest.blockSemicolon = false
* ensure to update dependency jars
