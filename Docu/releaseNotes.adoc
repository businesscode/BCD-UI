...
Some changes are incompatible to previous versions and may require code change in the project. They are listed here as well.

==== Release 5_0_1 in progress ...
...
* new dm:DimensionsAndMeasures/dm:Dimenions/dm:DimensionRef element now refences dm:Levels of entire Dimension from /bcdui/conf/dimensions.xml
...
Major bug fixes:
. gitInformation about git's local repo status is back again
