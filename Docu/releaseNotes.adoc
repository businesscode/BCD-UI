...
** Add OAuth2 authentication modules for Microsoft Azure / Graph and Google
...
* Menu: when using old scss themes, you need to specify bcdui.config.settings.bcdui.legacyTheme === true (settings.json)
