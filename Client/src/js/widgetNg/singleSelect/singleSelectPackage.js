...
//                bcdui.widgetNg.suggestInput._attachValidators(controlElement);
                ...
                if(args.validationFunction){
                  var func = bcdui.util.isString(args.validationFunction) ? bcdui.util._callJsFunction(args.validationFunction, null, null, true) : args.validationFunction;
                  if(!func){
    ...
    _ntv_syncToOptionsProvider: function(htmlElementId){
      ...
      bcdui.widgetNg.utils._updateInternalOptions({
        ...
        forEachFunc: function(index, attrNode){
          ...
          el.innerHTML = bcdui.util.escapeHtml(bcdui.util.unescapeHtml(valueObject.caption));
