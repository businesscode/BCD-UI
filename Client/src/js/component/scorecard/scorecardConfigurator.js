    ...
    _create : function(){
      ...
      bcdui.factory.objectRegistry.withReadyObjects([args.config, args.scorecard], function() {
        ...
        if (args.isDefaultHtmlLayout) {
          ...
          var defTemplate = `<div class='${cClass}'><div id='bcdUpDown_${args.cubeId || args.scorecardId}' class='bcdUpDown'></div><div id='bcdUpDownBody_${args.cubeId || args.scorecardId}'>`;
          [bcdui.component.cube.templateManager._renderTemplateArea, bcdui.component.scorecardConfigurator._renderDndArea, bcdui.component.cube.rankingEditor._renderRankingArea, bcdui.component.scorecardConfigurator._renderApplyArea].forEach(function(e) {if (typeof e == "function") defTemplate += e(args);});
          defTemplate += "</div>";
...
/** @lends bcdui.component.scorecardConfigurator */
{
  ...
  _renderDndArea: function(args) {
    if (jQuery("#" + args.targetHtml).hasClass("bcdDndBlindOpen") || jQuery("#" + args.targetHtml).hasClass("bcdDndBlindClosed"))
      return `<div id='bcdUpDown_Dnd_${args.cubeId || args.scorecardId}' class='bcdUpDown'></div><div id='bcdUpDownBody_Dnd_${args.cubeId || args.scorecardId}'><div id='bcdDndMatrixDiv_${args.cubeId || args.scorecardId}'>` + bcdui.component.scorecardConfigurator._generateDefaultLayout(args) + "</div></div>";
    else
      return `<div id='bcdDndMatrixDiv_${args.cubeId || args.scorecardId}'>` + bcdui.component.scorecardConfigurator._generateDefaultLayout(args) + "</div>";
  },
