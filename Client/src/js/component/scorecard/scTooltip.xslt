...
<xsl:param name="sccDefinition" select="*[false()]"/>
...
<xsl:template name="showAttrs">
  ...
  <xsl:if test="$sccDefinition">
    ...
    <!-- according to scorecard.xsd, Description element may occur as child of Extensions element. -->
