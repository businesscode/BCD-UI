  ...
  <xsl:template match="/*">
    <ContextMenu>
        ...
        <ContextMenuEntryGroup caption="KPI actions" >
          ...
          <xsl:if test="$targetPage">
            <xsl:if test="not($accessRight) or contains($bcdPageAccess, concat(' ', $accessRight, ' ')) or contains($bcdPageAccess, ' * ')">
              <Entry caption="Drill to analysis" data-bcd-action="drillToAnalysis" data-target-page="{concat($bcdContextPath,'/',$targetPage)}" >
          ...
          <xsl:if test="$bindingSet">
            <Entry caption="Export detail data" data-bcd-action="detailExport">
              <JavaScriptAction>
      ...
      <ContextMenuEntryGroup caption="Report action" >
        <Entry caption="Export report WYSIWYG" data-bcd-action="reportExcelExport">
