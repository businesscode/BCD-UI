...
bcdui.component.tree.ActionHandler = class {

    constructor() {
    this.contextMenuActionHandler = new bcdui.component.tree.ContextMenuAction();
  }
}

bcdui.component.tree.ContextMenuAction = class {
  ...
  _fullDataExport(args) {
    jQuery(args.bcdEventSourceElement).trigger("treeActions:fullDataExport");
  }
}
