...
//-----------------------------------------------------------------------------
  ...
  */
   ...
   * @private 
   */  
  XSLTProcessor.prototype.transformStylesheet = async function (args) {
    // load sef.json
  ...
  XSLTProcessor.prototype.asyncTransform = function(sourceDoc)
  {
    ...
    if (!this.stylesheetNode)
      resultPromise = this.transformStylesheet({stylesheetLocation: this.sefJson, sourceDoc: sourceDoc});
    ...
    // if we have a stylesheetNode which was generated by a loaded xslt (e.g. single cube chain xslts), we also have a belonging sef.json file 
      ...
      resultPromise = this.transformStylesheet({stylesheetLocation: bcdui.core.transformators.xsltToSefJson(this.stylesheetNode.URL), sourceDoc: sourceDoc});
    ...
    // if we have a stylesheetNode which was generated by a xslt transformation or dynamically e.g. as an inline model, we need to do a costy xslt3 transformation
      ...
      resultPromise = this.transformStylesheet({stylesheetLocation: bcdui.contextPath + "/bcdui/sef/xslt/xslt_transform.sef.json", sourceDoc: sourceDoc, genXslt: true});
