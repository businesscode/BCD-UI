...
>
  ...
  <xsl:template match="/">
    <Apis>
      ...
      <!-- JSP Api, one file per component -->
      ...
      <File name="gensrc/js/component/component.xslt" outputFormat="xml">
        <xsla:stylesheet version="1.0" xmlns:xapi="http://www.businesscode.de/schema/bcdui/xmlapi-1.0.0">
          ...
          <xsl:text>&#10;</xsl:text>
          <xsl:for-each select="document('../api/bcduiComponentApi_static.xslt')/*/xsl:template">
      ...
      <!-- Validate Api -->
      <File name="gensrc/js/component/componentValidate.js">
      <xsl:text>bcdui.factory.validate.component = bcdui.factory.validate.component || new Object();
jQuery.extend( bcdui.factory.validate.component, {&#10;  bcdSyntaxDummy: null&#10;</xsl:text>
