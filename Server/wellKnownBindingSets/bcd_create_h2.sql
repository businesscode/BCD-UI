...
ALTER TABLE bcd_tinyurl_control ADD CONSTRAINT PK_bcd_TINYURL_CONTROL PRIMARY KEY (tiny_url); -- TDOD
...
(
   ...
   meta_data      TEXT,
   CONSTRAINT bcd_virtual_file_system_pk UNIQUE(path, is_server, bcd_userId) -- TDOD
);
